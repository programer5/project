...
import toy.project.oauth2.service.OAuth2UserPrincipal;
import toy.project.oauth2.user.OAuth2Provider;
import toy.project.oauth2.user.OAuth2UserUnlinkManager;
import toy.project.oauth2.util.CookieUtils;

import java.io.IOException;
import java.util.Optional;

import static toy.project.oauth2.repository.HttpCookieOauth2AuthorizationRequestRepository.MODE_PARAM_COOKIE_NAME;
